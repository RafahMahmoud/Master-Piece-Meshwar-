...
//         businessTypes: [], // Will be set dynamically
...
//       // Set business types based on selections
//       const businessTypes = [];
...
//       const response = await axios.post('http://localhost:3003/api/partners/check-partner-budget', postData, {
//         withCredentials: true,
//       });

//       setBudgetCheckResult(response.data);  // Handle response
...
//       setSubmittedData(postData);  // Store the submitted data
//       setStep(6);
//     } catch (error) {
//       console.error('Error checking budget:', error);
//       setError('An error occurred while processing your request. Please try again.');
